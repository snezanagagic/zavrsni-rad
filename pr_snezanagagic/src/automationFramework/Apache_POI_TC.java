...
public class Apache_POI_TC {
	...
	public static void main(String[] args) throws Exception {
		...
		WebElement businessPage = driver
				.findElement(By.xpath("//a[@id='nav-bar-business']//div[@class='v-btn__content']"));
		businessPage.click();
		Thread.sleep(1000);
		...
		WebElement clientsPage = driver
				.findElement(By.xpath("//a[@id='nav-bar-clients']//div[@class='v-btn__content']"));
		clientsPage.click();
		Thread.sleep(1000);
